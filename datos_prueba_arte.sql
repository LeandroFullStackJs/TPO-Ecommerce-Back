...
INSERT INTO usuarios (nombre, apellido, email, password, rol, activo, fecha_creacion) VALUES
('Admin', 'ArtGallery', 'admin@artGallery.com', '$2a$10$vQE.xKhHgcnQGu3zOPTxbO/C.IhQKb.1VLtRjW8gv5HqxV.zOy8FO', 'ADMIN', true, NOW()),
('Demo', 'User', 'demo@artGallery.com', '$2a$10$vQE.xKhHgcnQGu3zOPTxbO/C.IhQKb.1VLtRjW8gv5HqxV.zOy8FO', 'USER', true, NOW()),
('Delfina', 'ArtGallery', 'delfi@artGallery.com', '$2a$10$vQE.xKhHgcnQGu3zOPTxbO/C.IhQKb.1VLtRjW8gv5HqxV.zOy8FO', 'USER', true, NOW()),
('Magali', 'Brandt', 'mbrandt@uade.edu.ar', '$2a$10$vQE.xKhHgcnQGu3zOPTxbO/C.IhQKb.1VLtRjW8gv5HqxV.zOy8FO', 'USER', true, NOW()),
('Delfina Pilar', 'Brunstein', 'del@gmail.com', '$2a$10$vQE.xKhHgcnQGu3zOPTxbO/C.IhQKb.1VLtRjW8gv5HqxV.zOy8FO', 'USER', true, NOW());
...
('Arte Abstracto', 'Arte abstracto moderno y contemporáneo', true, NOW()),
('Paisajes', 'Paisajes naturales y urbanos', true, NOW()),
('Retratos', 'Retratos y figura humana', true, NOW()),
('Geométrico', 'Arte geométrico y formas', true, NOW()),
('Naturaleza', 'Arte inspirado en la naturaleza', true, NOW()),
('Minimalista', 'Arte minimalista y simple', true, NOW()),
('Contemporáneo', 'Arte contemporáneo actual', true, NOW()),
('Texturizado', 'Arte con texturas especiales', true, NOW());

-- Obras de arte (productos) basadas en db.json con artistaId y usuarioId
INSERT INTO productos (nombre, descripcion, precio, stock, imagen, imagen_adicional1, imagen_adicional2, activo, destacado, 
...
('Sueño de Paisaje', 'Paisaje onírico que captura la esencia de la naturaleza en un momento de tranquilidad absoluta. Pintura al óleo.', 
 ...
 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400&h=600', 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=500&h=700', 
 true, true, 'Carlos Mendoza', 2, 1, 'Óleo', '70x50 cm', 2023, null, NOW(), NOW()),
...
('Sinfonía Geométrica', 'Composición geométrica que explora la armonía entre líneas, ángulos y espacios negativos.', 
 ...
 'https://images.unsplash.com/photo-1557804506-669a67965ba0?w=400&h=600', 'https://images.unsplash.com/photo-1557804506-669a67965ba0?w=500&h=700', 
...
('Explosión Floral', 'Interpretación moderna de la naturaleza con colores intensos y formas orgánicas fluidas.', 
 ...
 'https://images.unsplash.com/photo-1541961017774-22349e4a1262?w=400&h=600', 'https://images.unsplash.com/photo-1541961017774-22349e4a1262?w=500&h=700', 
...
('Esencia Minimalista', 'Obra minimalista que encuentra la belleza en la simplicidad y el espacio negativo.', 
 ...
 'https://images.unsplash.com/photo-1536924940846-227afb31e2a5?w=400&h=600', 'https://images.unsplash.com/photo-1536924940846-227afb31e2a5?w=500&h=700', 
...
('Movimiento Contemporáneo', 'Expresión del movimiento y la energía contemporránea a través de pinceladas dinámicas.', 
 ...
 'https://images.unsplash.com/photo-1549887534-1541e9326642?w=400&h=600', 'https://images.unsplash.com/photo-1549887534-1541e9326642?w=500&h=700', 
...
('Sueños Texturizados', 'Exploración de texturas y relieves que invitan al espectador a una experiencia táctil visual.', 
 ...
 'https://images.unsplash.com/photo-1561049501-e1f4c5c59257?w=400&h=600', 'https://images.unsplash.com/photo-1561049501-e1f4c5c59257?w=500&h=700', 
...
('Arte Abstracto Azul', 'Una descripción completa de esta obra abstracta con tonos azules dominantes.', 
 ...
 'https://images.unsplash.com/photo-1539900492308-6bcbb7b54a19?w=400&h=600', 'https://images.unsplash.com/photo-1539900492308-6bcbb7b54a19?w=500&h=700', 
...
('Paisaje Sereno', 'Un paisaje que transmite serenidad y paz interior.', 
 ...
 'https://images.unsplash.com/photo-1757167301106-7c3bedf90ecd?w=400&h=600', 'https://images.unsplash.com/photo-1757167301106-7c3bedf90ecd?w=500&h=700', 
...
('Nueva Obra Minimalista', 'Descripción completa del producto minimalista moderno.', 
 ...
 'https://plus.unsplash.com/premium_photo-1698001750831-dc8331d76fd8?w=400&h=600', 'https://plus.unsplash.com/premium_photo-1698001750831-dc8331d76fd8?w=500&h=700', 
...
('Retrato Urbano', 'Arte urbano que refleja la vida de la ciudad.', 
 ...
 'https://images.unsplash.com/photo-1731435265797-136ba0b95cda?w=400&h=600', 'https://images.unsplash.com/photo-1731435265797-136ba0b95cda?w=500&h=700', 
...
('Obra Emergente', 'Arte para uade - obra de artista emergente.', 
 ...
 'https://cdn.culturagenial.com/es/imagenes/arte-abstracto-og.jpg', 'https://cdn.culturagenial.com/es/imagenes/arte-abstracto-og.jpg', 
...
-- Sueño de Paisaje - Paisajes
(1, 2),
-- Sinfonía Geométrica - Geométrico
(2, 4),
-- Explosión Floral - Naturaleza
(3, 5),
-- Esencia Minimalista - Minimalista
(4, 6),
-- Movimiento Contemporáneo - Contemporáneo
(5, 7),
-- Sueños Texturizados - Texturizado
(6, 8),
-- Arte Abstracto Azul - Arte Abstracto
(7, 1),
-- Paisaje Sereno - Paisajes
(8, 2),
-- Nueva Obra Minimalista - Minimalista
(9, 6);
...
SELECT p.id, p.nombre, p.artista, p.artista_id, p.usuario_id, p.precio, p.stock, p.destacado,
